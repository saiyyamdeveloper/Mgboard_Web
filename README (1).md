...
🌿 **Mgboard_Web** is a privacy-first, zero-dependency responsive Web Keyboard for the **Masaram Gondi Script** (मासाराम गोंडी लिपि). Developed by **[Saiyyam Ji (@saiyyamdeveloper)](https://github.com/saiyyamdeveloper)**.
...
1. **🌐 3-Mode Smart Keyboard Switcher:**
   - **Masaram Gondi (Native 6-Row Layout):** Full Unicode 10.0+ / 17.0 standard support with 10 independent vowels (`𑴀`–`𑴋`), 37 consonants/conjuncts (`𑴌`–`𑴰`), and 10 matras (`𑴱`–`𑴶`).
